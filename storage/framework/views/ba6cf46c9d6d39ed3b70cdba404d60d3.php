...
<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row clearfix">
                    ...
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1"><?php echo e($request->subject); ?></h5>
                                <small class="text-muted"><?php echo e($request->created_at->diffForHumans()); ?></small>
                            </div>
                            <p class="mb-1"><?php echo e($request->description); ?></p>
            ...
            <div class="col-md-8">
                <?php if($request->status == 'in progress' || $request->status == 'solved'): ?>
                    <div class="card ">
                        <div class="chat">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#view_info">
                                            <img
                                                src="https://ui-avatars.com/api/?name=<?php echo e($request->student->name); ?>"alt="avatar">
                                        </a>
                                        <div class="chat-about">
                                            <h6 class="m-b-0"><?php echo e($request->student->name); ?></h6>
                                            <small><?php echo e($request->student->registration_no); ?></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <?php if($message->user_id == Auth::user()->id): ?>
                                                <li class=" justify-content-end">
                                                    ...
                                                    <div class="message-data ">
                                                        <span
                                                            class="message-data-time"><?php echo e($message->created_at->diffForHumans()); ?></span>
                                                    </div>
                                                </li>
                                            <?php else: ?>
                                                <li class="">
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="card-title mb-0">
                            <h5 class="m-0 me-2"><?php echo e($request->student->name); ?></h5>
                            ...
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                        ...
                                        <small class="text-muted"><?php echo e($request->student->registration_no); ?></small>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                        ...
                                        <small
                                            class="text-muted"><?php echo e($request->student->departments->faculties->name); ?></small>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                        ...
                                        <small class="text-muted"><?php echo e($request->student->departments->name); ?></small>
                                    </div>
                                </div>
                            </li>
                            <li class="d-flex mb-4 pb-1">
                                    ...
                                    <div class="me-2">
                                        ...
                                        <small class="text-muted">
                                            <?php if($request->priority == 'urgent'): ?>
                                                <span
                                                    class="badge rounded-pill bg-danger"><?php echo e($request->priority); ?></span>
                                            <?php elseif($request->priority == 'high'): ?>
                                                <span
                                                    class="badge rounded-pill bg-warning"><?php echo e($request->priority); ?></span>
                                            <?php endif; ?>
                                        </small>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                        ...
                                        <small
                                            class="text-muted"><?php echo e($request->assignedTo ? $request->assignedTo->name : '-----'); ?></small>
                                    </div>
                                </div>
                            </li>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex align-items-center">
                            <a href="#" class="list-group-item d-flex align-items-center"
                                data-bs-toggle="modal" data-bs-target="#attachmentModal<?php echo e($key); ?>">
                                <i class="bx bx-paperclip me-2"></i> <?php echo e($image); ?>

                            </a>
                        </li>
                    </ul>

                    <div class="modal fade" id="attachmentModal<?php echo e($key); ?>" tabindex="-1" aria-hidden="true" wire:ignore.self>
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    <img src="<?php echo e(asset('images/'.$image)); ?>" alt="<?php echo e($image); ?>" style="max-width: 100%; max-height: 100%;">
                                </div>
...
<?php endif; ?>
                            ...
                            <?php if(Auth::user()->hasRole('Support Agent')): ?>
                                <?php if($request->status == 'in progress'): ?>
                                    <div class="col-lg-12 ">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\StudentHelpDesk\resources\views/livewire/backend/chat/chat-component.blade.php ENDPATH**/ ?>