            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @role('Student')
                        ...
                        <li class="menu-item {{ request()->is('submit-request') ? 'active' : ' ' }}">
                            <a href="{{ route('submit-request') }}" class="menu-link">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ Auth::user()->roles[0]->name }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <span class="d-flex align-items-center align-middle">
                                                    ...
                                                    <span
                                                        class="flex-shrink-0 badge badge-center rounded-pill bg-danger w-px-20 h-px-20">{{ App\Models\Request::where('solved_id', Auth::user()->id)->where('status', 'in progress')->count() }}</span>
                                                </span>
                                            </a>
                                        </li>
                                        <li>
